--Runs_NET USER.sql	Runs NET user	3	
...
WHERE 
	...
	--[sfn].[FileName] in (N'sethc.exe',N'osk.exe',N'utilman.exe') AND
	---[se].[FileName__TargetProcessImageFileName] = N'NET.EXE' AND
	se.LaunchArguments_Target LIKE N'net% user %' AND
	[mp].[FK_Modules] != -1 AND
