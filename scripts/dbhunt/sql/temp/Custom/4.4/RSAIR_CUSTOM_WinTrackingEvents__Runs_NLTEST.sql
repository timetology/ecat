--NList Trust Relationship queries
--https://gallery.technet.microsoft.com/Use-NLTEST-to-test-domain-1a752686
...
WHERE 
se.FileName_Target = N'nltest.exe'
OR se.LaunchArguments_Target LIKE N'%/trusted_domains%'
OR se.LaunchArguments_Target LIKE N'%/server:%query%'
OR se.LaunchArguments_Target LIKE N'%/dclist:%'
