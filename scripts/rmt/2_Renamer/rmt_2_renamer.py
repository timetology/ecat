...
def main():
	...
	#Check if args.dir ends with a / or \
	if not (args.dir.endswith('\\') or args.dir.endswith('/')):
		#Append the appropriate slash
		#Check abs path to see if windows or linux dir structure
		print(os.path.abspath(args.dir))
		if '\\' in str(os.path.abspath(args.dir)):
			#path = str(os.path.abspath(args.dir) + '\\'
			args.dir = args.dir + '\\'
		elif '/' in str(os.path.abspath(args.dir)):
			#path = str(os.path.abspath(args.dir) + '\'
			args.dir = args.dir + '/'
	...
	for file in os.listdir(args.dir):
		try:
			...
			#Rename the file
			try:
				os.rename(args.dir + file, args.dir + newfile)
			except OSError as err:
				print('[-] Error Renaming {} to {}...'.format(args.dir + file,newfile))
			else:
				print('[+] Renamed {} to {}...'.format(args.dir + file,newfile))
	#Close the DB
	db.close()
