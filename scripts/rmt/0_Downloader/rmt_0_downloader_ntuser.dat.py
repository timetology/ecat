...
# 
# Description: Crawl NetWitness Endpoint looking for possible locations of NTUSER.DAT and then download them
#
# Example
#
# Change Log
		...
		try:
			...
			for i in dirlist:
				...
				try:
					...
					sleep(.1)
def main():
	parser = argparse.ArgumentParser(description='Download NTUSER.DAT')
