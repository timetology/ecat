--SHIMALIZER - WebFolders TargetPath
...
WHERE 
	...
	[se].[Path__TargetProcessPathName] LIKE '%\tomcat\%'
	OR [se].[Path__TargetProcessPathName] LIKE '%\inetpub\%'
	OR [se].[Path__TargetProcessPathName] LIKE '%\wwwroot\%'
	OR [se].[Path__TargetProcessPathName] LIKE '%\webapps\%'
	OR [se].[Path__TargetProcessPathName] LIKE '%\clientaccess\%'
