...
WHERE
	...
	[pn].[FileName] LIKE N'explorer.exe'
	...
	AND [dom].[Domain] NOT LIKE 'cdn.content.prod.cms.msn.com'
	AND [dom].[Domain] NOT LIKE '%.bing.com'
	AND [dom].[Domain] <> 'bing.com'
	AND [dom].[Domain] NOT LIKE '%.msn.com'
	AND [dom].[Domain] NOT LIKE '%.symcb.com'
	AND [dom].[Domain] NOT LIKE '%.onenote.net'
	AND [dom].[Domain] NOT LIKE '%.xboxlive.com'
	AND [dom].[Domain] NOT LIKE '%.weather.com'
	AND [dom].[Domain] <> 'windows.policies.live.net'
	-- AND [dom].[Domain] NOT LIKE '%.CLIENTDOMAIN'
